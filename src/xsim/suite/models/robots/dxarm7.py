...
# L/R follow the OPERATOR's perspective facing the rig (matches the physical
# teleop setup and xclients.motion.embodiment): dxarm-L is the arm on your
# left = +y = VMount4040(side=+1).
