...
class Config:
    ...
    # value credit per update instead of one. v7 (n=25, otherwise v6's recipe) reached
    # only 25% vs v6's 94% — the uncorrected off-policy bias hurt more than faster
    # credit helped at this n; smaller n (5-10) untested.
    nstep: int = 1
